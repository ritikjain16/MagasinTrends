...
const Home = (props) => {
  ...
  return (
    <div className="home-class-con">
      ...
      >
        {ismainloaded ? <div style={{display:"flex"}}>
        ...
        {/* ---------------------- */}
        {iscarouselloaded ? <CarouselProvider
          ...
          <Slider>
            {
              carouselList ? carouselList.map((item, index) => (
                <Slide index={index} key={item._id}>
                  ...
                  >
                    <img style={{ width: window.innerWidth, height: window.innerWidth>700?500:280 }} src={item.img_url} alt="" /></NavLink></Slide>
